...
spline manipulation, including differentiation, B - spline coefficient calculations.

## Features
This GUI application makes it easy to:-Load and visualize data (from multiple Data Sources:Custom function, 'CSV' files)with interactive Plotting:Zoom, pan, and add knots by clicking on the plot, configure B -
spline parameters (degree 1 to 4)
...
This package depends on:| Package | Purpose |
| --------- | --------- |
